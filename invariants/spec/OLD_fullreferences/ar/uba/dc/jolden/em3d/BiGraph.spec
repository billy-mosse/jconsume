		 ...
		 <method decl="ar.uba.dc.jolden.em3d.BiGraph create(int,int,boolean)">
			<relevant-parameters>numNodes_init, numDegree_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="56">
				...
				<constraints>
					<![CDATA[numDegree ==numDegree_init && numNodes ==numNodes_init && l___l0 == 783 && numDegree <numNodes]]>
				</constraints>
			 ...
			 <call-site offset="2" srccode-offset="60">
				...
				<constraints>
					<![CDATA[numDegree ==__i2 && numDegree ==numDegree_init && numNodes ==__i1 && numNodes ==numNodes_init && numDegree <numNodes]]>
				</constraints>
			 ...
			 <call-site offset="3" srccode-offset="61">
				...
				<callee>ar.uba.dc.jolden.em3d.Node: ar.uba.dc.jolden.em3d.Node[] fillTable(int,int)</callee>
				<constraints>
					<![CDATA[size_hTable ==__i1 && size_hTable ==numNodes_init && __i2 ==numDegree_init && size_hTable >__i2]]>
				</constraints>
				<binding>$t.size_init == __i1 and $t.degree_init == __i2</binding>
			 </call-site>
			 ...
			 <call-site offset="5" srccode-offset="68">
				...
				<constraints>
					<![CDATA[size_hTable ==size_eTable && size_hTable ==numNodes_init && size_hTable >numDegree_init]]>
				</constraints>
			 </call-site>
			 ...
			 <call-site offset="7" srccode-offset="71">
				...
				<constraints>
					<![CDATA[size_hTable ==size_eTable && size_hTable ==size___r8 && size_hTable ==numNodes_init && size_f___r5_toNodes ==numDegree_init && cont___r6 == 1 && size_hTable >size_f___r5_toNodes && size_hTable >cont___r6 && size_f___r5_toNodes >cont___r6]]>
				</constraints>
			 ...
			 <call-site offset="9" srccode-offset="73">
				...
				<callee>ar.uba.dc.jolden.em3d.Node: java.util.Enumeration elements()</callee>
				<constraints>
					<![CDATA[size_hTable ==numNodes_init && cont___r6 == 0 && size_hTable >numDegree_init && size_hTable >cont___r6 && numDegree_init >cont___r6]]>
				</constraints>
			 </call-site>
			 <call-site offset="12" srccode-offset="74">
				...
				<callee>java.util.Enumeration: boolean hasMoreElements()</callee>
				<constraints>
					<![CDATA[size_hTable ==numNodes_init && size_hTable >numDegree_init]]>
				</constraints>
			 </call-site>
			 ...
			 <call-site offset="11" srccode-offset="76">
				...
				<callee>ar.uba.dc.jolden.em3d.Node: void makeUniqueNeighbors(ar.uba.dc.jolden.em3d.Node[])</callee>
				<constraints>
					<![CDATA[size_hTable ==size___r8 && size_hTable ==numNodes_init && size_f___r5_toNodes ==numDegree_init && cont___r6 == 1 && size_hTable >size_f___r5_toNodes && size_hTable >cont___r6 && size_f___r5_toNodes >cont___r6]]>
				</constraints>
				<binding>$t.size_f_this_init_toNodes == size_f___r5_toNodes and $t.size_nodeTable_init == size___r8</binding>
			 </call-site>
		 ...
		 <method decl="void compute()">
			<relevant-parameters></relevant-parameters>
			 ...
			 <call-site offset="2" srccode-offset="121">
				...
				<constraints>
					<![CDATA[size_f___r1_fromNodes ==size_f___r1_coeffs && size_f___r1_fromNodes ==_f___r1_fromCount && d_f___r1_value == 0 && cont___r2 == 1 && size_f___r1_fromNodes >=d_f___r1_value]]>
				</constraints>
			 </call-site>
