		 ...
		 <method decl="void main(java.lang.String[])">
			<relevant-parameters>size_args_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="47">
				...
				<constraints>
					<![CDATA[size___r0 == size_args_init]]> <!-- tuve que agregar esta constraint y size_args_init como parametro. -->
				</constraints>
		 ...
		 <method decl="void mainParameters(int,int,boolean,boolean)">
			<relevant-parameters>numNodes_init, numDegree_init</relevant-parameters>
			 ...
			 <call-site offset="3" srccode-offset="112">
				...
				<callee>java.lang.System: long currentTimeMillis()</callee>
				<constraints>
					<![CDATA[numNodes_init >numDegree_init]]> <!-- aca tambien saque los l_start0 -->
				</constraints>
			 </call-site>
			 ...
			 <call-site offset="9" srccode-offset="121">
				...
				<callee>java.lang.System: long currentTimeMillis()</callee>
				<constraints>
					<![CDATA[l_start0 <l_end0 && l_start0 <numNodes_init && l_start0 <numDegree_init && l_end0 <numNodes_init && l_end0 <numDegree_init && numNodes_init >numDegree_init]]> <!-- aca hay variables inductivas que estan de mas, pero no influyen en el resultado-->
				</constraints>
			 </call-site>
