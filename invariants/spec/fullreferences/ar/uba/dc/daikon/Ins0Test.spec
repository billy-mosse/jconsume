...
<spec>
	 <class decl="ar.uba.dc.daikon.Ins0Test">
		 <method decl="void main(java.lang.String[])">
			<relevant-parameters></relevant-parameters>
			 ...
			 <call-site offset="3" srccode-offset="11">
				...
				<constraints>
					<![CDATA[i4 ==__i1 && i0 == 10 && r2_init__getClass______getName____ == java__lang__String______class && of length 1 && r2_init______toString == __10__ && size__r2_init______ == 1 && i0 >=i4 && i4 >= size__r2_init______ && $t__n_init == __i1]]>
				</constraints>
			 </call-site>
		</method>
	</class>
