...
<spec>
	<class decl="ar.uba.dc.ismm.MotivatingExample">
		...
		<method decl="ar.uba.dc.rinard.List map(ar.uba.dc.rinard.List,ar.uba.dc.ismm.Transform)">
			<relevant-parameters>list.size</relevant-parameters>
			<requires><![CDATA[list.size > 0]]></requires>
		...
		<method decl="ar.uba.dc.rinard.List safeMap(ar.uba.dc.rinard.List,ar.uba.dc.ismm.Transform)">
			<relevant-parameters>list.size</relevant-parameters>
			<requires><![CDATA[list.size > 0]]></requires>
		...
		<method decl="ar.uba.dc.rinard.List test(ar.uba.dc.rinard.List,ar.uba.dc.ismm.Transform)">
