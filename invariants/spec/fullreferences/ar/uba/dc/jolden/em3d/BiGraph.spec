...
<spec>
	 <class decl="em3d.BiGraph">
		 <method decl="em3d.BiGraph create(int,int,boolean)">
			<relevant-parameters>numNodes_init, numDegree_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="43">
				...
				<callee>em3d.Node: void initSeed(long)</callee>
				<constraints>
			 ...
			 <call-site offset="2" srccode-offset="49">
				...
				<callee>em3d.Node: em3d.Node[] fillTable(int,int)</callee>
				<constraints>
			 ...
			 <call-site offset="5" srccode-offset="57">
				<variables>numNodes_init, numDegree_init</variables>
				<inductives>numNodes_init, numDegree_init</inductives>
				<callee>em3d.Node: java.util.Enumeration elements()</callee>
				<constraints>
			 ...
			 <call-site offset="7" srccode-offset="60">
				...
				<inductives>size___r8, numNodes_init, numDegree_init, $t.size_nodeTable_init, $t.size_f_this_init_toNodes</inductives>
				<callee>em3d.Node: void makeUniqueNeighbors(em3d.Node[])</callee>
				<constraints>
			 ...
			 <call-site offset="16" srccode-offset="73">
				...
				<inductives>numNodes_init, numDegree_init, cont___r6, $t._f_this_init_fromCount</inductives>
				<callee>em3d.Node: void makeFromNodes()</callee>
				<constraints>
					<![CDATA[cont___r6 >= 1 && numNodes_init >=cont___r6 && _f___r5_fromCount ==numDegree_init && _f___r5_fromCount >= 0 &&  $t._f_this_init_fromCount == _f___r5_fromCount]]>
				</constraints>
			 </call-site>
			 ...
			 <call-site offset="20" srccode-offset="78">
				...
				<callee>em3d.Node: void makeFromNodes()</callee>
				<constraints>
					<![CDATA[cont___r6 >= 1 && numNodes_init >=cont___r6 && _f___r5_fromCount >= 0 && _f___r5_fromCount ==numDegree_init &&  $t._f_this_init_fromCount == _f___r5_fromCount]]>
				</constraints>
			 </call-site>
			 ...
			 <call-site offset="24" srccode-offset="85">
				...
				<inductives>numNodes_init, numDegree_init, $t.size_f_this_init_coeffs, $t.size_f_this_init_toNodes, $t._f_this_init_fromLength, $t.size_f_this_init_fromNodes</inductives>
				<callee>em3d.Node: void updateFromNodes()</callee>
				<constraints>
			 ...
			 <call-site offset="30" srccode-offset="94">
				<variables>numNodes_init, numDegree_init, cont___r6</variables>
				<inductives>numNodes_init, numDegree_init</inductives>
				<callee>em3d.BiGraph: void &lt;init&gt;(em3d.Node,em3d.Node)</callee>
				<constraints>
					<![CDATA[cont___r6 == 0 && numNodes_init >numDegree_init && numNodes_init >cont___r6 && numDegree_init >cont___r6]]>
				</constraints>
			 </call-site>
		 ...
		 <method decl="void &lt;init&gt;(em3d.Node,em3d.Node)">
			<relevant-parameters></relevant-parameters>
		 ...
		 <method decl="void compute()">
			<relevant-parameters></relevant-parameters>
			 ...
			 <call-site offset="2" srccode-offset="106">
				...
				<inductives></inductives>
				<callee>em3d.Node: void computeNewValue()</callee>
				<constraints>
