		 ...
		 <method decl="int computeDist(int,int,int)">
			<relevant-parameters>i_init, j_init, numvert_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="12100">
				...
				<inductives>__i1, i_init, j_init, numvert_init, i, j, numvert</inductives>
		 ...
		 <method decl="int random(int)">
			<relevant-parameters>seed_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="14301">
				<variables>seed, aux_15, seed_init</variables>
				<inductives>seed, aux_15, seed_init</inductives>
				<callee>ar.uba.dc.jolden.mst.Graph: int mult(int,int)</callee>
				<constraints>
					<![CDATA[seed == seed_init && seed >= 1 && aux_15 == 31415821 && seed < aux_15]]>
				</constraints>
			 </call-site>
		</method>
		 <method decl="void &lt;init&gt;(int)">
			<relevant-parameters>numvert_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="3200">
				...
				<inductives>numvert, this, numvert_init</inductives>
			 ...
			 <creation-site offset="0" srccode-offset="3300">
				...
				<inductives>numvert, this, numvert_init, aux_1, aux_1</inductives>
				<constraints>
					<![CDATA[numvert == numvert_init && 1<=aux_1 && aux_1<=numvert]]>
				</constraints>
			 </creation-site>
			 <creation-site offset="1" srccode-offset="3701">
				<variables>numvert, this, i, size___r2, v, numvert_init</variables>
				<inductives>numvert, this, i, size___r2, v, numvert_init</inductives>
				<constraints>
					<![CDATA[numvert == numvert_init && i >= 0 && numvert > i]]>
				</constraints>
			 </creation-site>
			 <call-site offset="1" srccode-offset="3702">
				<variables>numvert, this, i, size___r2, v, __r1, numvert_init</variables>
				<inductives>numvert, this, i, size___r2, v, __r1, numvert_init</inductives>
		 ...
		 <method decl="void addEdges(int)">
			<relevant-parameters>this_init, numvert_init</relevant-parameters>
			 <call-site offset="4" srccode-offset="9300">
				<variables>count1, numvert, __r1__f__array, __r1__f__size, this, tmp, this_init, numvert_init</variables>
				<inductives>count1, numvert, __r1__f__array, __r1__f__size, this, tmp, this_init, numvert_init</inductives>
			 ...
			 <call-site offset="0" srccode-offset="9400">
				<variables>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, this_init, numvert_init</variables>
				<inductives>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, this_init, numvert_init</inductives>
			 ...
			 <call-site offset="1" srccode-offset="9700">
				<variables>tmp, count1, numvert, i, __r1__f__array, __r1__f__size, this, this_init, numvert_init</variables>
				<inductives>tmp, count1, numvert, i, __r1__f__array, __r1__f__size, this, this_init, numvert_init</inductives>
			 ...
			 <creation-site offset="0" srccode-offset="9800">
				<variables>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __i2, this_init, numvert_init</variables>
				<inductives>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __i2, this_init, numvert_init</inductives>
				<constraints>
			 ...
			 <call-site offset="2" srccode-offset="9801">
				<variables>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __i2, __r5, this_init, numvert_init</variables>
				<inductives>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __i2, __r5, this_init, numvert_init</inductives>
			 ...
			 <call-site offset="3" srccode-offset="9802">
				<variables>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __r5, this_init, numvert_init</variables>
				<inductives>tmp, count1, numvert, __r1__f__array, __r1__f__size, this, i, __r6, __r5, this_init, numvert_init</inductives>
				<callee>ar.uba.dc.jolden.mst.Hashtable: void put(java.lang.Object,java.lang.Object)</callee>
				<constraints>
					<![CDATA[numvert == numvert_init && count1 >= 0 && __r1__f__size >= 2 && i >= 0 && count1 < numvert && numvert > __r1__f__size && numvert > i]]>
				</constraints>
				<binding>$t.this_init__f__array == __r1__f__array and $t.key_init == __r6 and $t.value_init == __r5</binding>
			 </call-site>
		</method>
	</class>
</spec>
