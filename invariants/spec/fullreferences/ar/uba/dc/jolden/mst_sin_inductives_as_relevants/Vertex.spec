		 ...
		 <method decl="void &lt;init&gt;(ar.uba.dc.jolden.mst.Vertex,int)">
			<relevant-parameters>n_init, numvert_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="3500">
				...
				<inductives>numvert, n, this, n_init, numvert_init</inductives>
			 ...
			 <creation-site offset="0" srccode-offset="3800">
				...
				<inductives>this, numvert, n_init, numvert_init, n</inductives>
				<constraints>
					<![CDATA[numvert == numvert_init]]>
				</constraints>
			 </creation-site>
			 <call-site offset="1" srccode-offset="3801">
				...
				<inductives>this, __i0, __r0, n_init, numvert_init, n, numvert</inductives>
