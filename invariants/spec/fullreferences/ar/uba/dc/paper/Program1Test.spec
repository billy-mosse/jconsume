		 ...
		 <method decl="void main(java.lang.String[])">
			<relevant-parameters></relevant-parameters>
			 ...
			 <creation-site offset="0" srccode-offset="8">
				...
				<constraints>
					<![CDATA[b___b3 ==size_args_init && count == 100 && b___b3 == 1 && count >=i && i >=b___b3 && 1<=aux_1 && aux_1<=b___b3]]>
				</constraints>
			 </creation-site>
			 <call-site offset="1" srccode-offset="9">
				...
				<constraints>
					<![CDATA[i ==__i1 && size_argsTest ==size___r0 && size_argsTest ==size_args_init && count == 100 && size_argsTest == 1 && count >=i && i >=size_argsTest]]>
				</constraints>
			 </call-site>
			 <call-site offset="2" srccode-offset="10">
				...
				<constraints>
					<![CDATA[size___r0 ==size_args_init && count == 100 && size___r0 == 1 && count >=i && i >=size___r0]]>
				</constraints>
