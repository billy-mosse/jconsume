		 ...
		 <method decl="bisort.Value createTree(int,int)">
			<relevant-parameters>size_init, seed_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="42">
				...
				<inductives>size_init, $t.origSize_init, $t.size_init, $t.seed_init</inductives>
		 ...
		 <method decl="bisort.Value createTreeRec(int,int,int)">
			<relevant-parameters>size_init, seed_init, origSize_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="48">
				...
				<inductives>origSize, size, size_init, origSize_init, $t.seed_init</inductives>
			 ...
			 <creation-site offset="0" srccode-offset="51">
				...
				<inductives>origSize, size, size_init, origSize_init</inductives>
				<constraints>
			 ...
			 <call-site offset="1" srccode-offset="51">
				...
				<inductives>origSize, size, size_init, origSize_init, $t.v_init</inductives>
			 ...
			 <call-site offset="2" srccode-offset="52">
				...
				<inductives>origSize, size, __i3, size_init, origSize_init, $t.origSize_init, $t.size_init, $t.seed_init</inductives>
				<callee>bisort.Value: bisort.Value createTreeRec(int,int,int)</callee>
				<constraints>
			 ...
			 <call-site offset="3" srccode-offset="53">
				...
				<inductives>origSize, size_init, origSize_init, $t.seed_init, $t.n_init</inductives>
			 ...
			 <call-site offset="4" srccode-offset="53">
				...
				<inductives>size_init, origSize_init, $t.origSize_init, $t.size_init, $t.seed_init</inductives>
				<callee>bisort.Value: bisort.Value createTreeRec(int,int,int)</callee>
				<constraints>
		 ...
		 <method decl="int bimerge(int,boolean)">
			<relevant-parameters>_f_this_init_value, spr_val_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="115">
				...
				<inductives>spr_val, _f_this_value, _f_prl_value, _f_pll_value, _f___r0_value, _f___r2_value, _f_this_init_value, spr_val_init, $t._f_n_init_value, $t._f_this_init_value</inductives>
			 ...
			 <call-site offset="1" srccode-offset="124">
				...
				<inductives>spr_val, _f_this_value, _f_prr_value, _f_plr_value, _f___r0_value, _f___r2_value, _f_this_init_value, spr_val_init, $t._f_n_init_value, $t._f_this_init_value</inductives>
			 ...
			 <call-site offset="2" srccode-offset="135">
				...
				<inductives>spr_val, _f_this_value, _f___r2_value, __i2, _f_this_init_value, spr_val_init, $t.spr_val_init, $t._f_this_init_value</inductives>
			 ...
			 <call-site offset="3" srccode-offset="136">
				...
				<inductives>_f___r0_value, __i0, _f_this_init_value, spr_val_init, $t.spr_val_init, $t._f_this_init_value</inductives>
				<callee>bisort.Value: int bimerge(int,boolean)</callee>
				<constraints>
		 ...
		 <method decl="int bisort(int,boolean)">
			<relevant-parameters>_f_this_init_value, spr_val_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="77">
				...
				<inductives>_f_this_value, spr_val, _f___r1_value, __i1, _f_this_init_value, spr_val_init, $t.spr_val_init, $t._f_this_init_value</inductives>
			 ...
			 <call-site offset="1" srccode-offset="79">
				...
				<inductives>_f_this_value, _f___r0_value, __i0, _f_this_init_value, spr_val_init, $t.spr_val_init, $t._f_this_init_value</inductives>
				<callee>bisort.Value: int bisort(int,boolean)</callee>
				<constraints>
		 ...
		 <method decl="int random(int)">
			<relevant-parameters>seed_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="218">
				...
				<inductives>__i0, __i1, seed_init, $t.p_init, $t.q_init</inductives>
		 ...
		 <method decl="int skiprand(int,int)">
			<relevant-parameters>seed_init, n_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="207">
				...
				<inductives>n, __i0, seed_init, n_init, $t.seed_init</inductives>
				<callee>bisort.Value: int random(int)</callee>
				<constraints>
		 ...
		 <method decl="void &lt;init&gt;(int)">
			<relevant-parameters>v_init</relevant-parameters>
			 <call-site offset="0" srccode-offset="28">
				...
				<inductives>v, v_init</inductives>
		 ...
		 <method decl="void inOrder()">
			<relevant-parameters>_f_this_init_value</relevant-parameters>
			 <call-site offset="0" srccode-offset="179">
				...
				<inductives>_f_this_value, _f___r0_value, _f_this_init_value, $t._f_this_init_value</inductives>
			 ...
			 <creation-site offset="0" srccode-offset="180">
				...
				<inductives>_f_this_value, _f_this_init_value</inductives>
				<constraints>
					<![CDATA[]]>
				</constraints>
			 </creation-site>
			 ...
			 <call-site offset="2" srccode-offset="180">
				...
				<inductives>_f_this_value, __i0, _f_this_init_value</inductives>
			 ...
			 <call-site offset="3" srccode-offset="180">
				...
				<inductives>_f_this_value, size___r5, _f_this_init_value</inductives>
			 ...
			 <call-site offset="7" srccode-offset="180">
				...
				<inductives>_f_this_value, size___r6, _f_this_init_value</inductives>
			 ...
			 <call-site offset="8" srccode-offset="182">
				...
				<inductives>_f___r0_value, _f_this_init_value, $t._f_this_init_value</inductives>
				<callee>bisort.Value: void inOrder()</callee>
				<constraints>
					<![CDATA[$t._f_this_init_value == _f___r0_value]]>
				</constraints>
