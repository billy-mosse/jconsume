...
$CURRNET_DIR/../run.sh "ar.uba.dc.tools.instrumentation.resource.tracker.madeja.InstrumentationTool" "$1" "$2" "$3"
#$CURRNET_DIR/../run.sh "ar.uba.dc.tools.instrumentation.resource.tracker.InstrumentationTool" "$1" "$2" "$3"