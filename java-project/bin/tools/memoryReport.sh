...
# ------------
# 
# Este script permite ejecutar la generacion del reporte HTML para el analisis de memoria para el metodo de una clase. 
...
$CURRNET_DIR/../run.sh "ar.uba.dc.tools.analysis.memory.impl.ReportWriterTool" "$1" "$2" "$3"