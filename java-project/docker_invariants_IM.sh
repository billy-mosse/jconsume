...
JCONSUME_FOLDER=$HOME/Projects/jconsume
...
find $PROJECT_FOLDER/out/$FULLNAMETEST -name InstrumentedMethod.java -exec sed -i -e 's/#/_/g' {} \;
...
javac -cp $CLASSPATH -g $FULLNAMETEST/$MYPATH/InstrumentedMethod.java || die "Problema en Phase 2"
