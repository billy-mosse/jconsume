...
./decorecompile.sh $1 $2 || die "Problema en fase 2"


echo Fase 3: Daikon for generating invariants


./__daikon.sh $FULLNAMETEST 10 > $1.$2/$FULLNAMETEST.txt
