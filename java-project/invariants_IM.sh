...
CLASSPATH_JCONSUME_FOLDERS=$PROJECT_FOLDER/target/classes/:$PROJECT_FOLDER/src/:$HOME/Projects/git/jconsume/jpfHelper/src:$PROJECT_FOLDER/src/main/java




CLASSPATH_JARS=$HOME/Downloads/soot-trunk.jar:$HOME/Projects/git/jconsume/dependencies/sootlib/jasminclasses-2.5.0.jar:$HOME/Projects/git/jconsume/dependencies/sootlib/polyglotclasses-1.3.5.jar:$M2_REPO/com/google/guava/guava/19.0/guava-19.0.jar
