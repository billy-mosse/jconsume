...
DAIKON_JAR=~/Programs/daikon/daikon-5.5.14/daikon.jar
...
java -cp $CLASSPATH daikon.Chicory "--output-dir=./daikon-output" "--ppt-select-pattern=.+\.InstrumentedMethod.*:::ENTER" "--ppt-select-pattern=dummyMethodForInstrumentation$" --nesting-depth=5 --dtrace-file=$1Test.dtrace.gz $1Test $2 
