...
PROJECT_FOLDER=$HOME/Projects/jconsume/java-project
...
#CLASSPATH=$DAIKON_JAR:/usr/lib/jvm/java-8-openjdk-amd64/lib/tools.jar:/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/jre/lib/rt.jar:/home/billy/Projects/git/jconsume-global/jconsume-global/src/:/home/billy/Projects/git/jconsume-global/jconsume-global/out/:/home/billy/Projects/git/jconsume-global/jconsume-global/src/main/examples/:$JAVA4CP:.



CLASSPATH=$DAIKON_JAR:/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/jre/lib/rt.jar:/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/lib/tools.jar:$PROJECT_FOLDER/out/$1/:$PROJECT_FOLDER/src/main/examples/
...
#daikon.derive.Derivation.disable_derived_variables=false está mal.

#--config_option daikon.Debug.show_stack_trace=false
#--config_option daikon.inv.binary.twoScalar.LinearBinary.enabled=false ax+by+c=0. Ojo que este es un formato nuevo que barvinok aceptaria pero hay que tener cuidado a la hora de parsearlo
java -cp $DAIKON_JAR::$CLASSPATH daikon.Daikon ./daikon-output/$1Test.dtrace.gz \
"--ppt-select-pattern=.+\.InstrumentedMethod.*:::ENTER" --nohierarchy --config_option daikon.inv.binary.twoScalar.FloatEqual.enabled=true --config_option daikon.inv.binary.twoScalar.LinearBinaryFloat.enabled=true --config_option daikon.inv.binary.twoScalar.LinearBinary.enabled=true --config_option daikon.inv.ternary.threeScalar.LinearTernaryFloat.enabled=true --config_option daikon.Debug.show_stack_trace=true --config_option daikon.inv.unary.scalar.Modulus.enabled=false --config_option  daikon.inv.unary.scalar.NonModulus.enabled=false --config_option daikon.inv.unary.scalar.LowerBound.enabled=true --config_option daikon.inv.binary.twoScalar.IntGreaterThan.enabled=true --config_option daikon.inv.binary.twoScalar.IntGreaterEqual.enabled=true --config_option daikon.inv.binary.twoScalar.IntEqual.enabled=true --config_option daikon.inv.binary.twoScalar.IntLessThan.enabled=true --config_option daikon.inv.binary.twoScalar.IntNonEqual.enabled=true --config_option daikon.derive.Derivation.disable_derived_variables=true --config_option daikon.inv.filter.DerivedParameterFilter.enabled=true --config_option daikon.derive.binary.SequenceFloatSubscript.enabled=true --config_option daikon.inv.unary.sequence.EltOneOf.enabled=false --config_option daikon.inv.binary.twoSequence.Reverse.enabled=true --config_option daikon.inv.binary.twoSequence.ReverseFloat.enabled=true --config_option  daikon.inv.binary.sequenceScalar.SeqIntEqual.enabled=false --config_option daikon.inv.unary.sequence.EltLowerBound.enabled=false --config_option daikon.inv.unary.sequence.EltUpperBound.enabled=false --config_option daikon.derive.unary.StringLength.enabled=true --config_option daikon.inv.unary.sequence.EltOneOf.enabled=false --config_option daikon.inv.binary.sequenceScalar.Member.enabled=false --config_option daikon.inv.unary.string.OneOfString.enabled=false  --config_option daikon.inv.unary.scalar.RangeInt.PowerOfTwo.enabled=false --config_option daikon.inv.binary.sequenceString.MemberString.enabled=false --config_option daikon.inv.binary.sequenceScalar.MemberFloat.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqFloatEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqFloatGreaterEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqFloatGreaterThan.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqFloatLessEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqFloatLessThan.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqIntEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqIntGreaterEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqIntGreaterThan.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqIntLessEqual.enabled=false --config_option daikon.inv.binary.sequenceScalar.SeqIntLessThan.enabled=false --config_option daikon.inv.unary.sequence.EltLowerBound.enabled=false --config_option daikon.inv.unary.sequence.EltLowerBoundFloat.enabled=false --config_option daikon.inv.unary.sequence.EltNonZero.enabled=false --config_option daikon.inv.unary.sequence.EltNonZeroFloat.enabled=false --config_option daikon.inv.unary.sequence.EltOneOf.enabled=false --config_option daikon.inv.unary.sequence.EltOneOfFloat.enabled=false --config_option daikon.inv.unary.sequence.EltRangeInt.Even.enabled=false --config_option daikon.inv.unary.sequence.EltRangeInt.PowerOfTwo.enabled=false --config_option daikon.inv.unary.sequence.EltUpperBound.enabled=false --config_option daikon.inv.unary.sequence.EltwiseFloatGreaterEqual.enabled=false --config_option daikon.inv.unary.sequence.EltwiseFloatGreaterThan.enabled=false --config_option daikon.inv.unary.sequence.EltwiseFloatLessEqual.enabled=false --config_option daikon.inv.unary.sequence.EltwiseFloatLessThan.enabled=false --config_option daikon.inv.unary.sequence.EltwiseIntEqual.enabled=false --config_option daikon.inv.unary.sequence.EltwiseIntGreaterEqual.enabled=false --config_option daikon.inv.unary.sequence.EltwiseIntGreaterThan.enabled=false --config_option daikon.inv.unary.sequence.EltwiseIntLessEqual.enabled=false --config_option daikon.inv.unary.sequence.EltwiseIntLessThan.enabled=false --config_option daikon.derive.unary.SequenceLength.enabled=true -o ./daikon-output/$1Test.inv.gz
