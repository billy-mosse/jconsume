...
$JAVA4BIN/java -cp $CLASSPATH -Xmx400m ar.uba.dc.analysis.automaticinvariants.instrumentation.daikon.invariantwriter.SpecInvariantWriter $FULLNAMETEST/$FULLNAMETEST /home/billy/Projects/git/jconsume/java-project/invariants/spec/fullreferences
