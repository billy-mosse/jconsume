...
CLASSPATH=/home/billy/Programs/daikon/daikon-5.5.14/daikon.jar:/usr/lib/jvm/java-8-oracle/jre/bin/jre/lib/rt.jar:/usr/lib/jvm/java-8-oracle/jre/bin/lib/tools.jar:/home/billy/Projects/git/jconsume/java-project/out/$1/:/home/billy/Programs/daikon/daikon-5.5.14/examples/java-examples/StackAr
...
echo java -cp $CLASSPATH daikon.Chicory "--output-dir=./daikon-output" "--ppt-select-pattern=InstrumentedMethod.*:::ENTER" --nesting-depth=3 --dtrace-file=$1.dtrace.gz $1 $2
