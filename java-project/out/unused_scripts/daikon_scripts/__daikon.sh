...
java -cp $CLASSPATH daikon.Chicory "--ppt-select-pattern=InstrumentedMethod2.*:::ENTER" "--output-dir=./daikon-output" --instrument-clinit --std-visibility --dtrace-file=$1Test.dtrace.gz   $1 $2
