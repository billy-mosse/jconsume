...
CLASSPATH=/home/billy/Programs/daikon/daikon-5.5.2/daikon.jar:/usr/lib/jvm/java-8-oracle/jre/bin/jre/lib/rt.jar:/usr/lib/jvm/java-8-oracle/jre/bin/lib/tools.jar:.
