...
java -cp $DAIKON_JAR::$CLASSPATH daikon.DynComp $1$2 $3
...
java -cp $DAIKON_JAR::$CLASSPATH daikon.Chicory "--output-dir=./daikon-output" --dtrace-file=$1$2.dtrace.gz --comparability-file=Field1.decls-DynComp $1$2 $3

echo Ejecutando Daikon

java -cp $DAIKON_JAR::$CLASSPATH daikon.Daikon ./daikon-output/$1$2.dtrace.gz -o ./daikon-output/$1$2.inv.gz
