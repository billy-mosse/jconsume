...
java -cp $DAIKON_JAR::$CLASSPATH daikon.Chicory "--output-dir=./daikon-output" --dtrace-file=$1$2.dtrace.gz --comparability-file=Field1.decls-DynComp "--ppt-select-pattern=InstrumentedMethod" $1$2 $a3
