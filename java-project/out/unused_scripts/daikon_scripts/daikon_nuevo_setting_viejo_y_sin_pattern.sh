...
CLASSPATH=/usr/lib/jvm/java-8-oracle/lib/tools.jar:/home/billy/Projects/git/jconsume-global/jconsume-global/src/:/home/billy/Projects/git/jconsume-global/jconsume-global/out/:/home/billy/Projects/git/jconsume-global/jconsume-global/src/main/examples/:$JAVA4CP:/home/billy/Projects/git/jconsume/java-project/src/main/examples/:.
...
java -cp $DAIKON_JAR::$CLASSPATH daikon.Chicory --premain=$CHICORY "--output-dir=./daikon-output" --dtrace-file=$1$2.dtrace.gz   $1$2 $3
