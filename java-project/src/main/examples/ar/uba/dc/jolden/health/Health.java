...
public class Health
{
  ...
  public static final void mainOrig(String args[]) {
	  parseCmdLine(args);
	  mainParameters(maxLevel, maxTime, seed, printMsgs, printResult);
  }
   ...
   **/
  public static final void mainParameters(int maxLevel, int maxTime, int seed, boolean printMsgs, boolean printResult)
  {
