...
public class Decoder implements DecoderErrors {
	 ...
	 */
	public Obuffer decodeFrame(Header header, Bitstream stream, FrameDecoder decoder) throws DecoderException {
	...
	/**
	 * TODO parametrico en header.mode()
	 * 
	 * Parametrico en el CHANNELS y en el estado del output
	 * @param header
	 * @throws DecoderException
	 */
