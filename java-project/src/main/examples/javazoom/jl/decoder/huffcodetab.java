...
final class huffcodetab {
	...
	private static int ValTab4[][] = {}; // dummy
...
*/
 	  private static int ValTab0[][] = huffcodetabValTab0.VAL(); // dummy
	 
	  private static int ValTab1[][] = huffcodetabValTab1.VAL();
	  
	  private static int ValTab2[][] = huffcodetabValTab2.VAL();
	  
	  private static int ValTab3[][] = huffcodetabValTab3.VAL();
	  
	  private static int ValTab4[][] = huffcodetabValTab4.VAL(); // dummy
	  
	  private static int ValTab5[][] = huffcodetabValTab5.VAL();
	  
	  private static int ValTab6[][] = huffcodetabValTab6.VAL();
	  
	  private static int ValTab7[][] = huffcodetabValTab7.VAL();
	  
	  private static int ValTab8[][] = huffcodetabValTab8.VAL();
	  
	  private static int ValTab9[][] = huffcodetabValTab9.VAL();
	  
	  private static int ValTab10[][] = huffcodetabValTab10.VAL();
	  
	  private static int ValTab11[][] = huffcodetabValTab11.VAL();
	  
	  private static int ValTab12[][] = huffcodetabValTab12.VAL();
	  
	  private static int ValTab13[][] = huffcodetabValTab13.VAL();
	  
	  private static int ValTab14[][] = huffcodetabValTab14.VAL(); // dummy
	  
	  private static int ValTab15[][] = huffcodetabValTab15.VAL();
	  
	  private static int ValTab16[][] = huffcodetabValTab16.VAL();
	  
	  private static int ValTab24[][] = huffcodetabValTab24.VAL();
	  
	  private static int ValTab32[][] = huffcodetabValTab32.VAL();
	  
	  private static int ValTab33[][] = huffcodetabValTab33.VAL();
