...
public class jlp {
	 ...
	 * Residual = 0
	 * Temporal = 0
	 * Los Strings estan definidos como valores fijos en tiempo de compilacion y no genera consumo dinamico.
	 */
	...
	/**
	 * Residual = 2 + Res(FileInputStream.init<>) + Res(BufferedInputStream.init<>)
	...
	/**
	 * Residual 1 + Res(JavaSoundAudioDevice.init<>)
	 * @return
