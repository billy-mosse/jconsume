...
public class DefaultSummaryRepository implements SummaryRepository<MemorySummary> {

	private static Log log = LogFactory.getLog(DefaultSummaryRepository.class);
	
	protected SummaryFactory<MemorySummary> summaryFactory;
	...
	public void setSummaryFactory(SummaryFactory<MemorySummary> summaryFactory) {
