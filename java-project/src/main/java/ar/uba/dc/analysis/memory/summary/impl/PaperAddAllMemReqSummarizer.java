...
public class PaperAddAllMemReqSummarizer implements PaperMemReqSummarizer<PaperMemorySummary, ParametricExpression> {
...
protected ParametricExpressionFactory expressionFactory;
	...
	//Billy agregado
	//pero no cambia nada :(
	public ParametricExpression getMemReq(PaperMemorySummary summary) {
