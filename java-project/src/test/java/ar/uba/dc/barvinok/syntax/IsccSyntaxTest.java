...
public class IsccSyntaxTest {
	...
	public void parseInfinite() {
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n] -> infty : n <= 0; [n] -> infty : n >= 1 }");
		assertThat(l.toString(), is(equalTo("[n] -> {[] -> infty: n <= 0; [] -> infty: n >= 1}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[n] -> []] -> infty : n <= 0; [[n] -> []] -> infty : n >= 1 }")));
		assertThat(l.getParameters().size(), is(equalTo(1)));
		assertThat(l.getParameters(), hasItem("n"));
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n] -> infty : n >= 0 and n <= 5; [n] -> infty : n >= 6 }");
		assertThat(l.toString(), is(equalTo("[n] -> {[] -> infty: n >= 0 and n <= 5; [] -> infty: n >= 6}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[n] -> []] -> infty : n >= 0 and n <= 5; [[n] -> []] -> infty : n >= 6 }")));
		assertThat(l.getParameters().size(), is(equalTo(1)));
		assertThat(l.getParameters(), hasItem("n"));
		assertThat(l.getPieces().size(), is(equalTo(2)));
		assertThat(l.getPieces().get(0).getVariables().size(), is(equalTo(0)));
	...
	public void NaNIsInterpretedAsInfinite() {
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n] -> NaN : n >= 0 and n <= 5; [n] -> NaN : n >= 6 }");
		assertThat(l.toString(), is(equalTo("[n] -> {[] -> infty: n >= 0 and n <= 5; [] -> infty: n >= 6}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[n] -> []] -> infty : n >= 0 and n <= 5; [[n] -> []] -> infty : n >= 6 }")));
		assertThat(l.getParameters().size(), is(equalTo(1)));
		assertThat(l.getParameters(), hasItem("n"));
	...
	public void parsePolynomials() {
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n] -> (n + n^2) : n >= 0 and n <= 5; [n] -> n : n >= 6; n^2 : n <= -1 }");
		assertThat(l.toString(), is(equalTo("[n] -> {[] -> n + n^2: n >= 0 and n <= 5; [] -> n: n >= 6; [] -> n^2: n <= -1}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[n] -> []] -> n + n^2 : n >= 0 and n <= 5; [[n] -> []] -> n : n >= 6; [[n] -> []] -> n^2 : n <= -1 }")));
		assertThat(l.getParameters().size(), is(equalTo(1)));
		assertThat(l.getParameters(), hasItem("n"));
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n, m] -> ((5 + n) + 3 * m) : n >= 1 and m >= 0; [n, m] -> n : n >= 1 and m <= -1; [n, m] -> (5 + 3 * m) : m >= 0 and n <= 0 }");
		assertThat(l.toString(), is(equalTo("[m,n] -> {[] -> (5 + n) + 3 * m: n >= 1 and m >= 0; [] -> n: n >= 1 and m <= -1; [] -> 5 + 3 * m: m >= 0 and n <= 0}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[m,n] -> []] -> (5 + n) + 3 * m : n >= 1 and m >= 0; [[m,n] -> []] -> n : n >= 1 and m <= -1; [[m,n] -> []] -> 5 + 3 * m : m >= 0 and n <= 0 }")));
		...
		l = syntax.parsePiecewiseQuasipolynomial("{[n, m] ->  (n + m^2) : m = 5 and n <= 5 and n >= 0; [n, m] -> n : (n >= 0 and m <= 4) or (n >= 0 and m >= 6) or (m = 5 and n >= 6); [n, m] ->m^2 : m = 5 and n <= -1 }");
		...
		assertThat(syntax.toString(l), is(equalTo("{ [[m,n] -> []] -> n + m^2 : m == 5 and n <= 5 and n >= 0; [[m,n] -> []] -> n : (n >= 0 and m <= 4) or (n >= 0 and m >= 6) or (m == 5 and n >= 6); [[m,n] -> []] -> m^2 : m == 5 and n <= -1 }")));
		assertThat(l.getParameters().size(), is(equalTo(2)));
		assertThat(l.getParameters(), hasItem("n"));
		assertThat(l.getParameters(), hasItem("m"));
		assertThat(l.getPieces().size(), is(equalTo(3)));
	...
	public void parseMaximum() {
		PiecewiseQuasipolynomial l = syntax.parsePiecewiseQuasipolynomial("{  }");
		assertThat(l.toString(), is(equalTo("[] -> {[] -> 0}")));
		assertThat(syntax.toString(l), is(equalTo("{ 0 }")));
		assertThat(l.getParameters().size(), is(equalTo(0)));
		assertThat(l.getPieces().size(), is(equalTo(1)));
		...
		l = syntax.parsePiecewiseQuasipolynomial("{ [n, m] ->max(infty) : m >= 1 + n;[n, m] -> max(n * m, m^2, n^2) : m <= n }");
		assertThat(l.toString(), is(equalTo("[m,n] -> {[] -> max(infty): m >= 1 + n; [] -> max(n * m, m^2, n^2): m <= n}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[m,n] -> []] -> max(infty) : m >= 1 + n; [[m,n] -> []] -> max(n * m, m^2, n^2) : m <= n }")));
		assertThat(l.getParameters().size(), is(equalTo(2)));
		assertThat(l.getParameters(), hasItem("n"));
		assertThat(l.getParameters(), hasItem("m"));
		assertThat(l.getPieces().size(), is(equalTo(2)));
		...
		l = syntax.parsePiecewiseQuasipolynomial("({  }, True)");
		assertThat(l.toString(), is(equalTo("[] -> {[] -> 0}")));
		assertThat(syntax.toString(l), is(equalTo("{ 0 }")));
		assertThat(l.getParameters().size(), is(equalTo(0)));
		assertThat(l.getPieces().size(), is(equalTo(1)));
		...
		l = syntax.parsePiecewiseQuasipolynomial("({ [n, m] ->max(infty) : m >= 1 + n;[n, m] -> max(n * m, m^2, n^2) : m <= n }, False)");
		assertThat(l.toString(), is(equalTo("[m,n] -> {[] -> max(infty): m >= 1 + n; [] -> max(n * m, m^2, n^2): m <= n}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[m,n] -> []] -> max(infty) : m >= 1 + n; [[m,n] -> []] -> max(n * m, m^2, n^2) : m <= n }")));
		assertThat(l.getParameters().size(), is(equalTo(2)));
		assertThat(l.getParameters(), hasItem("n"));
	...
	public void stripPartOnlyIfSurroundAllTerm() {
		PiecewiseQuasipolynomial l = syntax.parsePiecewiseQuasipolynomial("{ [a, b] -> (1 + a) * b : a >= 1 and b >= 2; [a, b] -> b : b >= 2 and a <= 0; [a, b] -> (1 + a) : a >= 1 and b <= 1; [a, b] -> 1 : b <= 1 and a <= 0 }");
		assertThat(l.toString(), is(equalTo("[a,b] -> {[] -> (1 + a) * b: a >= 1 and b >= 2; [] -> b: b >= 2 and a <= 0; [] -> 1 + a: a >= 1 and b <= 1; [] -> 1: b <= 1 and a <= 0}")));
		assertThat(syntax.toString(l), is(equalTo("{ [[a,b] -> []] -> (1 + a) * b : a >= 1 and b >= 2; [[a,b] -> []] -> b : b >= 2 and a <= 0; [[a,b] -> []] -> 1 + a : a >= 1 and b <= 1; [[a,b] -> []] -> 1 : b <= 1 and a <= 0 }")));
		assertThat(l.getParameters().size(), is(equalTo(2)));
		assertThat(l.getParameters(), hasItem("a"));
